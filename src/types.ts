...
export interface IDbCategory extends Omit<
  ICategory,
  "createdAt" | "updatedAt"
> {
  createdAt: Date;
...
export const TRecipeFilter = Type.Object({
  ...
  minCalories: Type.Optional(Type.Number()),
  maxCalories: Type.Optional(Type.Number()),
  minProtein: Type.Optional(Type.Number()),
  maxProtein: Type.Optional(Type.Number()),
  minCarbs: Type.Optional(Type.Number()),
...
export interface IDbMealPlan extends Omit<
  IMealPlan,
...
export interface IDbShoppingList extends Omit<
  IShoppingList,
  "createdAt" | "updatedAt"
> {
  createdAt: Date;
...
export interface IDbShareRecipe extends Omit<
  IShareRecipe,
  "createdAt" | "updatedAt"
> {
  createdAt: Date;
